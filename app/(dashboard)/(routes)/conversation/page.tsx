...
// axios simplifies the process of sending asynchronous HTTP requests to APIs and handling the responses.
...
const ConversationPage = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      router.refresh();
      //refresh all the server component and this help us to track the api count in api counter ui
    }
  }
